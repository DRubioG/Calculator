...
HD_PWD='c:/users/xd/documents/onedrive - universidad de alcala/calculator/calculator/ip_repo/edit_prueba_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prueba_v1_0.tcl -notrace
