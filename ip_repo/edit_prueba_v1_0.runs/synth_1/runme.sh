...
HD_PWD='c:/users/xd/documents/onedrive - universidad de alcala/calculator/calculator/ip_repo/edit_prueba_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_v1_0.tcl
